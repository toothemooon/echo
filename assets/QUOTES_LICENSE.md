# Quote Data Licensing and Attribution

The application code and the bundled quote data have different provenance.
...
`quotes.ja.json` is adapted from Japanese Wikiquote. The adapted catalog and
its metadata are provided under the Creative Commons Attribution-ShareAlike
license used by Japanese Wikiquote. Attribution and the exact source revision
for every record are retained in
